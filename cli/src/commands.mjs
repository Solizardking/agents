...
export async function cmdStatus(options = {}) {
  ...
  const result = {
    ...
    hubs: {
      ...
      skillsGithub: OPEN_SOURCE_REPOS.skills.url,
      skillhubGithub: OPEN_SOURCE_REPOS.skillhub.url,
    },
...
export async function cmdConnect(options = {}) {
  ...
  return {
    ...
    sourceOfTruth: {
      ...
      openSource: "agents · cli · eliza · cheshire-terminal · skills · skillhub-main",
    },
    ...
    productHubs: {
      ...
      skills: hubs.skills || "https://cheshireterminal.ai/skills",
