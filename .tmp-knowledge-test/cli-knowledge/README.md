...
Curated agent memory for **Warren Buffett** — structured like the OpenClawd
...
knowledge/
  README.md                 # this file
  warren-buffett-character.md          # character narrative (clawd-character.md shape)
  facts.jsonl
...
Primary narrative: **warren-buffett-character.md** — sections Lore · Voice · Style Rules · Agent Knowledge Summary
(base: package `knowledge/clawd-character.md`).

---

Generated by `ct-agents knowledge init` for Warren Buffett.
