...
Generated by `ct-agents dna generate` from character `clawd`.
...
```bash
npx cheshire-terminal-agents dna generate --from clawd --out /Users/8bit/solana-clawd-agent-kit-2/agents/.tmp-dna-test/generated-dna --force
```
