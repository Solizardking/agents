...
export function deriveBrowserAgentRecommendation(
  ...
  if (agent.category === "trading") {
    ...
    addDocById("deployment", "faq", "troubleshooting", "redpill-solana-attestation", "open-source-release");
    ...
    addDocById("agent_guide", "examples", "models", "cheshire-launchpad-mainnet-plan", "phoenix-perps-integration");
  }
  ...
  if (agent.metaplexSkills.length > 0 || id.includes("registry") || id.includes("mint")) {
    ...
    addDocById("deployment", "api", "cheshire-launchpad-mainnet-plan", "redpill-solana-attestation");
  }
  ...
  if (includesAny(tags, ["pumpfun", "pumpswap", "copy-trading"]) || id.includes("pumpfun")) {
    ...
    addDocById("deployment", "workflow", "troubleshooting", "live-agent-arena-trading", "live-trading-release");
  }
  ...
  if (id.includes("vulcan") || includesAny(tags, ["perps", "phoenix", "vulcan"])) {
    ...
    addDocById("deployment", "examples", "workflow", "phoenix-perps-integration", "live-agent-arena-trading");
  }
  ...
  if (id.includes("orchestrator") || includesAny(tags, ["multi-agent", "orchestration", "payments"])) {
    ...
    addDocById("api", "deployment", "workflow", "cheshire-terminal-api", "agent-arena-creator-earnings", "supabase-clerk-setup");
  }
